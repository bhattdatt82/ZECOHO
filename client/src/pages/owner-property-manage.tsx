...
function RoomOptionsSection({ roomId }: { roomId: string }) {
  ...
  const handleStartEdit = (option: RoomOption) => {
    setEditingOptionId(option.id);
    setEditOptionName(option.name);
    setEditOptionPrice(String(option.priceAdjustment || "0"));
                  ...
                  <div className="grid gap-3 md:grid-cols-3">
                    <div className="space-y-1">
                      ...
                      <Input
                        ...
                        data-testid={`edit-option-name-${option.id}`}
                      />
                    </div>
                    <div className="space-y-1">
                      ...
                      <Input
                        ...
                        placeholder="0"
                        data-testid={`edit-option-price-${option.id}`}
                      />
                    </div>
                    <div className="space-y-1">
                      ...
                      <Input
                        ...
                        data-testid={`edit-option-inclusions-${option.id}`}
                      />
                    </div>
                  </div>
                  <div className="flex gap-2">
